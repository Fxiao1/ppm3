...
/*表结构修改*/
ALTER TABLE PPM_DATA_INSTANCE add("CHECK_TIME_1" TIMESTAMP (6) DEFAULT sysdate);
UPDATE 		PPM_DATA_INSTANCE SET CHECK_TIME_1=CHECK_TIME;
ALTER TABLE PPM_DATA_INSTANCE DROP COLUMN CHECK_TIME;
ALTER TABLE PPM_DATA_INSTANCE RENAME COLUMN CHECK_TIME_1 TO CHECK_TIME;
