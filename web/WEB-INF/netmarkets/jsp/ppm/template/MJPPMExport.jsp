<%@page import="ext.modular.common.MJReportExcelUtil"%>
...
<%
    ...
    try {
        ...
        excelContent = controller.getMJPPMCalculateDetailList(startStr,endStr);
        System.out.println("excelContent size() " + excelContent.size());

        MJReportExcelUtil reportExcel=new MJReportExcelUtil();
        reportExcel.setDataList(excelContent);
        //"图号" + "版本" +".xls"
        String fileName = "模件PPM.xls";
