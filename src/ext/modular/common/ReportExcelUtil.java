...
public class ReportExcelUtil {
    ...
    public String writeExcelFile(String fileName) throws Exception {
        ...
        String fromPath = wthome + File.separator + "codebase" + File.separator + "ext" + File.separator + "ppm"
                + File.separator + "templates" + File.separator + "工序PPM.xls";
...
//                    rgu.mergedCell(sheet,rowNumber,n,4,5);
                    rgu.setCellWithStyle(rowNumber, 0, bean.getProcedureName());
                    rgu.setCellWithStyle(rowNumber, 1, String.valueOf(bean.getProcedurePPM()));
/*                    if (n > 1){
